/*define([ 'angular', './sample-module' ], function(angular, controllers) {
	...
	controllers.controller('loginCtrl', ['$scope','$http',function($scope, $http) {
				...
				console.log("login form js entry");
				
				$scope.login = function() {		
					console.log("login submit"+document.getElementById("sso").value+" "+document.getElementById("password").value);
					var sso = document.getElementById("sso").value;
					var password=document.getElementById("password").value;
					if(password!=null && password !=undefined && password !="")
						password = $scope.encryptPassword(document.getElementById("password").value);
					else
						return;
					...
					$http({
						...
						data    :  {
							...
							console.log("status : "+status+" statusCode : "+statusCode);
				...
				$scope.encryptPassword = function(pwd) {
					return $scope.MD5(pwd);
