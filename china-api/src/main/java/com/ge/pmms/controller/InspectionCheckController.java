...
public class InspectionCheckController {
	...
	@RequestMapping(value = "/validateMantainenceSSO", method = RequestMethod.GET)
	public Response validateMantainenceSSO(@RequestBody(required = false) String sso) {
	JSONObject jsonData = new JSONObject(sso);		
	String data=(String) jsonData.get("sso");
	...
	if(data!=null && !("".equalsIgnoreCase(data))) 
		response = inspectionCheckService.validateMantainenceSSO(data);
