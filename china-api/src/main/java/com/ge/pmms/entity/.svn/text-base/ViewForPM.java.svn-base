...
@Entity
@Table(name = "v_pm_workorder", schema = "PMMS")
public class ViewForPM implements Serializable{
	...
	public ViewForPM(Integer id, String woId, String woType, String woStatus, String equipId, String shutDownFlag,
